...
const features = [
  {
    ...
    title: 'Authority', 
    description: 'Became a respected thought leader in your industry'
  },
  
  {
    icon: <Clock className="w-12 h-12 text-purple-500" />
    title: 'Efficient',
    description: 'Skyrocket your socia media growth with minimal effort'
  },

  {
    icon: <Rocket className="w-12 h-12 text-purple-500" />,
    title: 'Return',
    decription: 'Increase leads and sales with inbound customer acquisition' 
  }
];
